...
const Home = () => {
    // useEffect(() => {}, [])
    return (_jsx("div", { className: "h-100%  box-borderpb-0px", children: _jsx("div", { className: "h-100%  bg-white", children: _jsx("div", { id: "container", className: "h-100%  p-10px ", children: examples.map((example) => {
                    return (_jsxs("div", { className: "border-1px border-#ebeef5 w-400px cursor-pointer", style: { boxShadow: '0 2px 12px 0 rgba(0,0,0,.1)' }, onClick: () => {
