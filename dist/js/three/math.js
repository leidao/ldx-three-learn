...
/** 球面坐标转经纬度 */
export const xyz2lon = (x, y, z, radius) => {
...
/** 根据三个点位获取外接圆的圆心坐标 */
export const threePointToCenter = (p1, p2, p3) => {
...
/** 空间中任意两点旋转到XOY平面上 */
export const startEndQuaternion = (startSphere, endSphere) => {
    /** 圆心坐标 */
    ...
    /** 旋转到XOY平面 */
    const quaternion_XOY = new THREE.Quaternion().setFromUnitVectors(normal, xoyNormal1);
    ...
    /** 旋转后y轴向上 */
    const quaternion_XOY_Y = new THREE.Quaternion().setFromUnitVectors(midDir, yDir);
